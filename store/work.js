export const state = {
  ...
  work: [],
  works: [
    { title: 'ポートフォリオ', about: '自分自身のポートフォリオサイトです。', text: '自身のポートフォリオサイトとして当サイトを作成しました。', back: '自分自身のスキルや制作物をまとめるために作成しました。', img: require('~/assets/portfolio-img.png'), tech: 'Nuxt.js', responsive: '◯', day: '7日', ingenuity: ['SPAでサイトを作成したこと', 'コンポーネントの切り替えや様々なアニメーションを実装出来たこと', 'お問い合わせフォームが実装出来たこと'], url: '', git: 'https://github.com/hiro0214/portfolio' },

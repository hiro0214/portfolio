export const state = {
  ...
  work: [],
  works: [
    { title: 'ポートフォリオ', about: '自分自身のポートフォリオサイトです。', text: '自身のポートフォリオサイトとして当サイトを作成しました。', back: '自分自身のスキルや制作物をまとめるために作成しました。', img: require('~/assets/portfolio-img.png'), tech: 'Nuxt.js / Firebase', responsive: '◯', day: '7日', ingenuity: ['SPAでサイトを作成したこと', 'コンポーネントの切り替えや様々なアニメーションを実装出来たこと', 'お問い合わせフォームが実装出来たこと'], url: '', git: 'https://github.com/hiro0214/portfolio' },
    ...
    { title: '某フリマアプリサイト', about: 'スクールの最終課題で作成したクローンサイトです。', text: '本物のサイトと同じようにクローンサイトを作成しました。', back: 'スクールの最終課題であったため作成しました。', img: require('~/assets/mercari-img.png'), tech: 'Ruby on Rails / jQuery / AWS(EC2, S3)', responsive: '×', day: '4人チームで1ヶ月', ingenuity: ['DB設計や各機能の実装など、自分で考えて実装出来たこと', 'チームとしてメンバーと足並みを揃えながらサイトを作成したこと'], url: 'http://13.115.148.93/', git: 'https://github.com/hiro0214/freemarket_sample_60c' },
    { title: 'タイピングゲーム', about: 'エンジニアがよく使う言葉のタイピングゲームを作りました。', text: 'エンジニアが使う用語やコマンドをタイピングゲームにして作成しました。スコア機能やランキング機能も実装しました。', back: 'エンジニアにとってタイピング速度は大事なもので、それを鍛えることが出来るゲームがあれば良いと思い作成しました。', img: require('~/assets/typing-img.png'), tech: 'Nuxt.js / Firebase', responsive: '×', day: '5日', ingenuity: ['タイピングの判定や画面の表示などが思うように実装出来たこと'], url: 'https://typing-74d28.firebaseapp.com', git: 'https://github.com/hiro0214/typing' }
  ]
}
...
export const actions = {
  ...
  workOffset({ commit }, payload) {
    commit('workOffset', payload)
  },
